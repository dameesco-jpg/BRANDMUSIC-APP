  ...
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden py-12">
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-1/4 w-96 h-96 bg-electric-cyan/20 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          y: [0, 30, 0],
        ...
        className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-electric-pink/20 rounded-full blur-3xl"
      />
        ...
        >
          ...
          <div className="bg-surface-elevated rounded-2xl p-8 border border-white/10 backdrop-blur-glass">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-electric-blue/20 rounded-full mb-4">
              ...
              <p className="text-text-secondary">
                Start discovering music in seconds
              </p>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div className="flex items-start">
                <input
                  type="checkbox"
                  id="terms"
                  className="mt-1 w-4 h-4 rounded border-white/20 bg-surface text-electric-blue focus:ring-electric-blue focus:ring-offset-0"
                />
                <label htmlFor="terms" className="ml-2 text-sm text-text-secondary">
                  I agree to the{' '}
                  <Link href="/terms" className="text-electric-blue hover:text-electric-cyan">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-electric-blue hover:text-electric-cyan">
                    Privacy Policy
                  </Link>
                </label>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-surface-elevated text-text-tertiary">Or sign up with</span>
              </div>
            </div>
          ...
          <p className="text-center mt-6 text-text-secondary">
            ...
            <Link href="/login" className="text-electric-blue hover:text-electric-cyan transition-colors font-semibold">
              Log in
            </Link>
          </p>
        </motion.div>
